...
userid = validation.testInt("Matrícula: ")
    ...
    if menuAction == "1":
        ...
        if updateList == "1":  # Editar alguma reclamação
            ...
            if not claims.getClaims():
                ...
                positionToUpdate = validation.testPositionList(
                    "Registro a ser alterado: ", claims.claimsId
                )
            ...
            if not compliments.getCompliments():
                ...
                positionToUpdate = validation.testPositionList(
                    "Registro a ser Alterado: ", compliments.complimentsId
                )
                newValue = validation.testString("Digite seu novo feedback: ")
            ...
            if not suggestions.getSuggestions():
                ...
                print(suggestions.getSuggestions())
                positionToUpdate = validation.testPositionList(
                    "Registro a ser alterado: ", suggestions.suggestionsId
                )
                newValue = validation.testString("Digite seu novo feedback: ")
